...
The quantity to watch here is the **exposure value (EV)** https://en.wikipedia.org/wiki/Exposure_value. The *sunny 16* settings `N = 16` and `t = 1/100 s` yield required exposure value at 100 ISO of 
```math
